...
def main():
    ...
    if "## Runtime workflow" not in text:
        fail("SKILL.md must contain '## Runtime workflow'")
    if "## Tool policy" not in text:
        fail("SKILL.md must contain '## Tool policy'")
    if "## Memory policy" not in text:
        fail("SKILL.md must contain '## Memory policy'")
    if "## Output requirements" not in text:
        fail("SKILL.md must contain '## Output requirements'")
    if "## Quality gates" not in text:
        fail("SKILL.md must contain '## Quality gates'")
