...
description: Research Factory Orchestrator for OpenClaw: v19.3 artifact-only compute (synchronous execute, final-answer.md, result-manifest, stdout marker) with gateway-side channel delivery; v19.2.x honesty guardrails retained for queue/outbox paths. Condensed operator sheet in SKILL-core.md.
license: internal
metadata:
  version: "19.3"
