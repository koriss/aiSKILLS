...
print(json.dumps({'provider':'cli','event_id':args.event_id or event.get('event_id'),'status':'sent','stub_delivery':False,'real_external_delivery':True,'acked_at':now}, ensure_ascii=False))
