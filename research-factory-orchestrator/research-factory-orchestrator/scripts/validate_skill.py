...
required_contracts = ["artifact-contract.json", "artifact-result-contract.json", "validator-dag.json", "delivery-contract.json", "interface-adapter-contract.json", "provider-contract.json", "canonical-package-layout-contract.json", "runtime-queue-contract.json", "outbox-contract.json", "source-acquisition-reliability-contract.json", "execution-reliability-contract.json", "context-acquisition-contract.json", "delivery-truth-contract.json", "seed-only-run-contract.json", "manual-fallback-contract.json", "core-boundary-contract.json", "rfo-effective-config-v1.schema.json", "rfo-effective-config-v2.schema.json", "source-packet-v1.schema.json", "supported-skill-actions-v1.json", "supported-skill-actions-v2.json"]
