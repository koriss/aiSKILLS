...
1. **v19.0.3 closure pass** — fail-closed rollback uses `minimal_valid` + physical rollback stub; release `REQUIRED_GATES` + B4 transcript self-attestation; dual Telegram smokes (legacy + `RFO_V19_PROFILE=mvr`); see `docs/release-notes/v19.0.3.md` (and `v19.0.2.md` for prior patch notes).
