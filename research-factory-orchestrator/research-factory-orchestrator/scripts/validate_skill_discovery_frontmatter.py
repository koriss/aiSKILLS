...
if not text.startswith('---'):
    ...
    if 'version: "19.3"' not in fm: errors.append('wrong_or_missing_metadata_version_v19_3')
out={'status':'fail' if errors else 'pass','validator':'validate_skill_discovery_frontmatter','version':'19.3','errors':errors}
